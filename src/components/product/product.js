...
import { getDiscontPrice, Discount } from '../discount-price'
import { addToCart } from '../../features/useCartSlice'

const CardAction = ({element, image}) => {
...
const ProductVisualize = ({element, endpoint}) => {
...
export const ProductPage = ({endpoint}) => {
    const {id} = useParams();
